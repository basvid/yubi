      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
            ...
            <li><a href="#about">Gestion &eacute;tablissements</a></li>
            <li><a href="#contact">Attributions chambres</a></li>
          </ul>
        </div><!--/.nav-collapse -->
      </div>
    </div>
...
if ($_REQUEST['action']=='demanderSupprEtab')    
{
   ...
   Oui</a>&nbsp; &nbsp; &nbsp; &nbsp;
   <a href='gestion.php?'>Non</a></h5></center>";
}
...
else
{
   ...
   <a href='gestion.php?'>Retour</a></center>";
}
